...
public class CourseController {
    ...
    public ResponseEntity<GetCourseResponse> getCourseById(@PathVariable(COURSE_ID) String courseId, @AuthenticationPrincipal String userId) {
    ...
    public ResponseEntity<List<GetCourseResponse>> getCoursesByCategory(@RequestParam(name = CATEGORY, required = false) String category, @AuthenticationPrincipal String userId) {
    ...
    public ResponseEntity<List<GetCourseResponse>> getMyCourses(@AuthenticationPrincipal String userId) {
    ...
    public ResponseEntity<List<Void>> addFavCourse(@PathVariable(COURSE_ID) String courseId, @AuthenticationPrincipal String userId) {
    ...
    public ResponseEntity<List<GetCourseResponse>> getMyFavCourses(@AuthenticationPrincipal String userId) {
